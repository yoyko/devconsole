...
var _elm_lang$websocket$WebSocket$set = F2(
	function (value, maybeDict) {
		var _p1 = maybeDict;
		if (_p1.ctor === 'Nothing') {
			return _elm_lang$core$Maybe$Just(
				_elm_lang$core$Dict$fromList(
...
var _elm_lang$websocket$WebSocket$buildEntriesDict = F2(
	function (subs, dict) {
		buildEntriesDict:
		while (true) {
			var _p2 = subs;
		...
		while (true) {
			...
			if (_p6.ctor === '[]') {
				...
				var _v9 = _p6._1,
					...
					_elm_lang$core$Dict$update,
					_p6._0._0,
					_elm_lang$websocket$WebSocket$set(
						{ctor: '_Tuple2', _0: _p6._0._1, _1: _p6._0._2}),
					dict);
				subs = _v9;
				dict = _v10;
...
var _elm_lang$websocket$WebSocket$cmdHelp = F3(
	function (router, cmds, socketsDict) {
		var _p8 = cmds;
		if (_p8.ctor === '[]') {
			return _elm_lang$core$Task$succeed(socketsDict);
		} else {
			var _p9 = A2(_elm_lang$core$Dict$get, _p8._0._0, socketsDict);
			if ((_p9.ctor === 'Just') && (_p9._0.ctor === 'Connected')) {
				return A2(
					_elm_lang$websocket$WebSocket_ops['&>'],
					A2(_elm_lang$websocket$WebSocket_LowLevel$send, _p9._0._0, _p8._0._1),
					A3(_elm_lang$websocket$WebSocket$cmdHelp, router, _p8._1, socketsDict));
			} else {
				return _elm_lang$core$Task$succeed(socketsDict);
			}
		}
...
var _elm_lang$websocket$WebSocket$State = F2(
	function (a, b) {
		return {sockets: a, subs: b};
	});
var _elm_lang$websocket$WebSocket$init = _elm_lang$core$Task$succeed(
	A2(_elm_lang$websocket$WebSocket$State, _elm_lang$core$Dict$empty, _elm_lang$core$Dict$empty));
...
var _elm_lang$websocket$WebSocket$MySub = F3(
	function (a, b, c) {
...
var _elm_lang$websocket$WebSocket$listen = F2(
	function (url, tagger) {
		return _elm_lang$websocket$WebSocket$subscription(
			A3(_elm_lang$websocket$WebSocket$MySub, 'listen', url, tagger));
	});
var _elm_lang$websocket$WebSocket$onOpen = function (tagger) {
	return _elm_lang$websocket$WebSocket$subscription(
		A3(_elm_lang$websocket$WebSocket$MySub, 'onOpen', '', tagger));
};
var _elm_lang$websocket$WebSocket$onClose = function (tagger) {
	return _elm_lang$websocket$WebSocket$subscription(
		A3(_elm_lang$websocket$WebSocket$MySub, 'onClose', '', tagger));
};
var _elm_lang$websocket$WebSocket$subMap = F2(
	function (func, sub) {
		var _p13 = sub;
		return A3(
			_elm_lang$websocket$WebSocket$MySub,
			_p13._0,
			_p13._1,
			function (_p14) {
				return func(
...
var _elm_lang$websocket$WebSocket$onEffects = F4(
	function (router, cmds, subs, state) {
		var rightStep = F3(
			function (category, connection, getNewSockets) {
				return A2(
					_elm_lang$websocket$WebSocket_ops['&>'],
		...
		var bothStep = F4(
			function (category, _p17, connection, getNewSockets) {
				return A2(
					_elm_lang$core$Task$map,
					A2(_elm_lang$core$Dict$insert, category, connection),
					getNewSockets);
			});
		var leftStep = F3(
			function (category, _p18, getNewSockets) {
				return A2(
					_elm_lang$core$Task$andThen,
					function (newSockets) {
						return A2(
							...
							A3(_elm_lang$websocket$WebSocket$attemptOpen, router, 0, category));
					},
					getNewSockets);
			});
		var newEntries = A2(_elm_lang$websocket$WebSocket$buildEntriesDict, subs, _elm_lang$core$Dict$empty);
		...
		return A2(
			...
			function (newSockets) {
				return _elm_lang$core$Task$succeed(
					A2(_elm_lang$websocket$WebSocket$State, newSockets, newSubs));
			},
			A2(
				_elm_lang$websocket$WebSocket_ops['&>'],
				A3(_elm_lang$websocket$WebSocket$cmdHelp, router, cmds, state.sockets),
				collectNewSockets));
	});
var _elm_lang$websocket$WebSocket$retryConnection = F4(
	function (router, n, name, state) {
		return A2(
			_elm_lang$core$Task$andThen,
			function (pid) {
				return _elm_lang$core$Task$succeed(
					A3(
						...
						name,
						A2(_elm_lang$websocket$WebSocket$Opening, n + 1, pid),
						state));
			},
			A3(_elm_lang$websocket$WebSocket$attemptOpen, router, n + 1, name));
	});
var _elm_lang$websocket$WebSocket$onSelfMsg = F3(
	function (router, selfMsg, state) {
		...
		switch (_p19.ctor) {
				...
				var sends = A2(
					...
					_elm_lang$core$Dict$toList(
						A2(
							_elm_lang$core$Maybe$withDefault,
							_elm_lang$core$Dict$empty,
							A2(_elm_lang$core$Dict$get, 'listen', state.subs))));
				return A2(
					_elm_lang$websocket$WebSocket_ops['&>'],
			...
			case 'Die':
				var _p25 = _p19._0;
				var _p22 = A2(_elm_lang$core$Dict$get, _p25, state.sockets);
				if (_p22.ctor === 'Nothing') {
					return _elm_lang$core$Task$succeed(state);
				} else {
					if (_p22._0.ctor === 'Connected') {
						var sends = A2(
							_elm_lang$core$List$map,
							function (_p23) {
								var _p24 = _p23;
							...
							_elm_lang$core$Dict$toList(
								A2(
									_elm_lang$core$Maybe$withDefault,
									_elm_lang$core$Dict$empty,
									A2(_elm_lang$core$Dict$get, 'onClose', state.subs))));
						return A2(
							_elm_lang$core$Task$andThen,
							function (pid) {
								return _elm_lang$core$Task$succeed(
							...
							A2(
								_elm_lang$websocket$WebSocket_ops['&>'],
								_elm_lang$core$Task$sequence(sends),
								A3(_elm_lang$websocket$WebSocket$attemptOpen, router, 0, _p25)));
					} else {
						return A4(_elm_lang$websocket$WebSocket$retryConnection, router, _p22._0._0, _p25, state);
					}
				}
			case 'GoodOpen':
				var _p28 = _p19._0;
				var sends = A2(
					...
					_elm_lang$core$Dict$toList(
						A2(
							_elm_lang$core$Maybe$withDefault,
							_elm_lang$core$Dict$empty,
							A2(_elm_lang$core$Dict$get, 'onOpen', state.subs))));
				return A2(
					_elm_lang$websocket$WebSocket_ops['&>'],
					_elm_lang$core$Task$sequence(sends),
			...
			default:
				var _p30 = _p19._0;
				var _p29 = A2(_elm_lang$core$Dict$get, _p30, state.sockets);
				if (_p29.ctor === 'Nothing') {
					return _elm_lang$core$Task$succeed(state);
				} else {
					if (_p29._0.ctor === 'Opening') {
						return A4(_elm_lang$websocket$WebSocket$retryConnection, router, _p29._0._0, _p30, state);
					} else {
						return _elm_lang$core$Task$succeed(state);
					}
				}
...
var _rluiten$elm_date_extra$Date_Extra_I18n_I_de_de$dayOfMonthWithSuffix = F2(
	function (pad, day) {
		return A2(
			_elm_lang$core$Basics_ops['++'],
...
var _rluiten$elm_date_extra$Date_Extra_I18n_I_de_de$monthName = function (month) {
	var _p0 = month;
	switch (_p0.ctor) {
		case 'Jan':
			return 'Januar';
...
var _rluiten$elm_date_extra$Date_Extra_I18n_I_de_de$monthShort = function (month) {
	var _p1 = month;
	switch (_p1.ctor) {
		case 'Jan':
			return 'Jan';
...
var _rluiten$elm_date_extra$Date_Extra_I18n_I_de_de$dayName = function (day) {
	var _p2 = day;
	switch (_p2.ctor) {
		case 'Mon':
			return 'Montag';
...
var _rluiten$elm_date_extra$Date_Extra_I18n_I_de_de$dayShort = function (day) {
	var _p3 = day;
	switch (_p3.ctor) {
		case 'Mon':
			return 'Mo';
...
var _rluiten$elm_date_extra$Date_Extra_Config_Config_de_de$config = {
	i18n: {dayShort: _rluiten$elm_date_extra$Date_Extra_I18n_I_de_de$dayShort, dayName: _rluiten$elm_date_extra$Date_Extra_I18n_I_de_de$dayName, monthShort: _rluiten$elm_date_extra$Date_Extra_I18n_I_de_de$monthShort, monthName: _rluiten$elm_date_extra$Date_Extra_I18n_I_de_de$monthName, dayOfMonthWithSuffix: _rluiten$elm_date_extra$Date_Extra_I18n_I_de_de$dayOfMonthWithSuffix},
	format: {date: '%-d. %B %Y', longDate: '%A, %-d. %B %Y', time: '%-H:%M', longTime: '%-H:%M:%S', dateTime: '%a, %-d. %b %Y. %-H:%M:%S', firstDayOfWeek: _elm_lang$core$Date$Mon}
};
...
var _rluiten$elm_date_extra$Date_Extra_Config_Config_ja_jp$config = {
	i18n: {dayShort: _rluiten$elm_date_extra$Date_Extra_I18n_I_ja_jp$dayShort, dayName: _rluiten$elm_date_extra$Date_Extra_I18n_I_ja_jp$dayName, monthShort: _rluiten$elm_date_extra$Date_Extra_I18n_I_ja_jp$monthShort, monthName: _rluiten$elm_date_extra$Date_Extra_I18n_I_ja_jp$monthName, dayOfMonthWithSuffix: _rluiten$elm_date_extra$Date_Extra_I18n_I_ja_jp$dayOfMonthWithSuffix},
...
var _rluiten$elm_date_extra$Date_Extra_Config_Config_lt_lt$config = {
	i18n: {dayShort: _rluiten$elm_date_extra$Date_Extra_I18n_I_lt_lt$dayShort, dayName: _rluiten$elm_date_extra$Date_Extra_I18n_I_lt_lt$dayName, monthShort: _rluiten$elm_date_extra$Date_Extra_I18n_I_lt_lt$monthShort, monthName: _rluiten$elm_date_extra$Date_Extra_I18n_I_lt_lt$monthName, dayOfMonthWithSuffix: _rluiten$elm_date_extra$Date_Extra_I18n_I_lt_lt$dayOfMonthWithSuffix},
...
var _rluiten$elm_date_extra$Date_Extra_I18n_I_ru_ru$dayOfMonthWithSuffix = F2(
	function (pad, day) {
		var _p0 = day;
		return _elm_lang$core$Basics$toString(day);
	});
var _rluiten$elm_date_extra$Date_Extra_I18n_I_ru_ru$monthName = function (month) {
	var _p1 = month;
	switch (_p1.ctor) {
		case 'Jan':
			return 'Январь';
...
var _rluiten$elm_date_extra$Date_Extra_I18n_I_ru_ru$monthShort = function (month) {
	var _p2 = month;
	switch (_p2.ctor) {
		case 'Jan':
			return 'Янв';
...
var _rluiten$elm_date_extra$Date_Extra_I18n_I_ru_ru$dayName = function (day) {
	var _p3 = day;
	switch (_p3.ctor) {
		case 'Mon':
			return 'Понедельник';
...
var _rluiten$elm_date_extra$Date_Extra_I18n_I_ru_ru$dayShort = function (day) {
	var _p4 = day;
	switch (_p4.ctor) {
		case 'Mon':
			return 'Пн';
...
var _rluiten$elm_date_extra$Date_Extra_Config_Config_ru_ru$config = {
	i18n: {dayShort: _rluiten$elm_date_extra$Date_Extra_I18n_I_ru_ru$dayShort, dayName: _rluiten$elm_date_extra$Date_Extra_I18n_I_ru_ru$dayName, monthShort: _rluiten$elm_date_extra$Date_Extra_I18n_I_ru_ru$monthShort, monthName: _rluiten$elm_date_extra$Date_Extra_I18n_I_ru_ru$monthName, dayOfMonthWithSuffix: _rluiten$elm_date_extra$Date_Extra_I18n_I_ru_ru$dayOfMonthWithSuffix},
	format: {date: '%d/%m/%Y', longDate: '%A, %B %d, %Y', time: '%H:%M', longTime: '%H:%M:%S', dateTime: '%d/%m/%Y %H:%M', firstDayOfWeek: _elm_lang$core$Date$Mon}
};

var _rluiten$elm_date_extra$Date_Extra_I18n_I_tr_tr$dayOfMonthWithSuffix = F2(
	function (pad, day) {
		return A2(
			_elm_lang$core$Basics_ops['++'],
			_elm_lang$core$Basics$toString(day),
...
var _rluiten$elm_date_extra$Date_Extra_I18n_I_tr_tr$monthName = function (month) {
	var _p0 = month;
	switch (_p0.ctor) {
		case 'Jan':
			return 'Ocak';
...
var _rluiten$elm_date_extra$Date_Extra_I18n_I_tr_tr$monthShort = function (month) {
	var _p1 = month;
	switch (_p1.ctor) {
		case 'Jan':
			return 'Oca';
...
var _rluiten$elm_date_extra$Date_Extra_I18n_I_tr_tr$dayName = function (day) {
	var _p2 = day;
	switch (_p2.ctor) {
		case 'Mon':
			return 'Pazartesi';
...
var _rluiten$elm_date_extra$Date_Extra_I18n_I_tr_tr$dayShort = function (day) {
	var _p3 = day;
	switch (_p3.ctor) {
		case 'Mon':
			return 'Pzt';
...
var _rluiten$elm_date_extra$Date_Extra_Config_Config_tr_tr$config = {
	i18n: {dayShort: _rluiten$elm_date_extra$Date_Extra_I18n_I_tr_tr$dayShort, dayName: _rluiten$elm_date_extra$Date_Extra_I18n_I_tr_tr$dayName, monthShort: _rluiten$elm_date_extra$Date_Extra_I18n_I_tr_tr$monthShort, monthName: _rluiten$elm_date_extra$Date_Extra_I18n_I_tr_tr$monthName, dayOfMonthWithSuffix: _rluiten$elm_date_extra$Date_Extra_I18n_I_tr_tr$dayOfMonthWithSuffix},
	format: {date: '%d.%m.%Y', longDate: '%d %B %Y %A', time: '%H:%M', longTime: '%H:%M:%S', dateTime: '%d %B %Y %-H:%M:%S', firstDayOfWeek: _elm_lang$core$Date$Mon}
};
												...
												_1: {
													...
													_1: {
														...
														_1: {
															...
															_1: {
																ctor: '::',
																_0: {ctor: '_Tuple2', _0: 'lt_lt', _1: _rluiten$elm_date_extra$Date_Extra_Config_Config_lt_lt$config},
																_1: {ctor: '[]'}
															}
														}
													}
...
var _user$project$Connection$model = function (id) {
	return {
		id: id,
		url: A2(
			_elm_lang$core$Basics_ops['++'],
			'ws://nuvo.local:8000/apiWs',
			A2(_elm_lang$core$Basics_ops['++'], '?', id)),
		messages: {ctor: '[]'},
		lastTs: 0
	};
};
var _user$project$Connection$Model = F4(
	function (a, b, c, d) {
		return {id: a, url: b, messages: c, lastTs: d};
	});
var _user$project$Connection$Closed = F2(
	function (a, b) {
		return {ctor: 'Closed', _0: a, _1: b};
	});
var _user$project$Connection$Opened = F2(
	function (a, b) {
		return {ctor: 'Opened', _0: a, _1: b};
	});
var _user$project$Connection$Received = F2(
	function (a, b) {
		return {ctor: 'Received', _0: a, _1: b};
	});
var _user$project$Connection$Sent = F2(
	function (a, b) {
		return {ctor: 'Sent', _0: a, _1: b};
	});
var _user$project$Connection$Timestamped = F2(
	function (a, b) {
		return {ctor: 'Timestamped', _0: a, _1: b};
	});
var _user$project$Connection$update = F3(
	function (lift, msg, model) {
		...
		while (true) {
			...
			var onlyAddMessage = function (msg) {
				return {
					ctor: '_Tuple2',
					_0: addMessage(msg),
					_1: _elm_lang$core$Platform_Cmd$none
			...
			switch (_p0.ctor) {
				case 'Send':
					...
					return {
						ctor: '_Tuple2',
						_0: addMessage(
							A2(_user$project$Connection$Sent, model.lastTs, _p1)),
						_1: A2(_elm_lang$websocket$WebSocket$send, model.url, _p1)
					};
				case 'Response':
					return onlyAddMessage(
						A2(_user$project$Connection$Received, model.lastTs, _p0._0));
				case 'WsOpened':
					return onlyAddMessage(
						A2(_user$project$Connection$Opened, model.lastTs, _p0._0));
				case 'WsClosed':
					return onlyAddMessage(
						A2(_user$project$Connection$Closed, model.lastTs, _p0._0));
				case 'Timestamp':
					return {
						ctor: '_Tuple2',
						_0: model,
						_1: A2(
							...
							function (_p2) {
								return lift(
									A2(_user$project$Connection$Timestamped, _p0._0, _p2));
							},
...
var _user$project$Connection$Timestamp = function (a) {
	return {ctor: 'Timestamp', _0: a};
};
var _user$project$Connection$WsOpened = function (a) {
	return {ctor: 'WsOpened', _0: a};
};
var _user$project$Connection$WsClosed = function (a) {
	return {ctor: 'WsClosed', _0: a};
};
var _user$project$Connection$Response = function (a) {
	return {ctor: 'Response', _0: a};
};
var _user$project$Connection$subscriptions = F2(
	function (lift, model) {
		return _elm_lang$core$Platform_Sub$batch(
			{
				ctor: '::',
				_0: A2(
					...
					function (_p3) {
						return lift(
							_user$project$Connection$Timestamp(
								_user$project$Connection$Response(_p3)));
					}),
				_1: {
					ctor: '::',
					_0: _elm_lang$websocket$WebSocket$onOpen(
						function (_p4) {
							return lift(
								_user$project$Connection$Timestamp(
									_user$project$Connection$WsOpened(_p4)));
						}),
					_1: {
						ctor: '::',
						_0: _elm_lang$websocket$WebSocket$onClose(
							function (_p5) {
								return lift(
									_user$project$Connection$Timestamp(
										_user$project$Connection$WsClosed(_p5)));
							}),
						_1: {ctor: '[]'}
					}
				}
...
var _user$project$Connection$Send = function (a) {
	return {ctor: 'Send', _0: a};
};
var _user$project$Connection$send = F3(
	function (lift, model, msg) {
		return {
			ctor: '_Tuple2',
			_0: model,
			_1: A2(
				...
				function (_p6) {
					return lift(
						A2(
							_user$project$Connection$Timestamped,
							_user$project$Connection$Send(msg),
							_p6));
				},
				_elm_lang$core$Time$now)
		};
...
var _user$project$Delegate$delegate = F3(
	function (_p0, big, f) {
		var _p1 = _p0;
		var _p2 = _p1._0;
		return A2(
			...
			function (v) {
				return A2(_p2.set, v, big);
			},
			f(
				_p2.get(big)));
	});
var _user$project$Delegate$Delegate = function (a) {
	return {ctor: 'Delegate', _0: a};
};
var _user$project$Delegate$create = F2(
	function (get, set) {
		return _user$project$Delegate$Delegate(
			{get: get, set: set});
	});

var _user$project$Message_Edit_Model$context = F4(
	function (msgLift, sendRequest, mdlLift, mdl) {
		return {msgLift: msgLift, sendRequest: sendRequest, mdlLift: mdlLift, mdl: mdl};
	});
var _user$project$Message_Edit_Model$Model = function (a) {
	return function (b) {
		return function (c) {
			return function (d) {
				return function (e) {
					return function (f) {
						return function (g) {
							return function (h) {
								return function (i) {
									return function (j) {
										return {activeTab: a, id: b, nextAutoId: c, customId: d, expandedId: e, rawMessage: f, url: g, browseFrom: h, browseCount: i, browseType: j};
									};
								};
							};
						};
...
var _user$project$Message_Edit_Model$Context = F4(
	function (a, b, c, d) {
		return {msgLift: a, sendRequest: b, mdlLift: c, mdl: d};
	});
var _user$project$Message_Edit_Model$Custom = {ctor: 'Custom'};
var _user$project$Message_Edit_Model$None = {ctor: 'None'};
var _user$project$Message_Edit_Model$AutoInc = {ctor: 'AutoInc'};
var _user$project$Message_Edit_Model$Incremental = {ctor: 'Incremental'};
var _user$project$Message_Edit_Model$Menu = {ctor: 'Menu'};
var _user$project$Message_Edit_Model$Normal = {ctor: 'Normal'};
var _user$project$Message_Edit_Model$model = {activeTab: 0, id: _user$project$Message_Edit_Model$AutoInc, nextAutoId: 0, customId: '', expandedId: false, rawMessage: '{\"method\":\"ping\"}', url: '/stable/av/volume', browseFrom: '', browseCount: '', browseType: _user$project$Message_Edit_Model$Normal};
var _user$project$Message_Edit_Model$Toggle = {ctor: 'Toggle'};
var _user$project$Message_Edit_Model$Adjust = {ctor: 'Adjust'};
var _user$project$Message_Edit_Model$Set = {ctor: 'Set'};
var _user$project$Message_Edit_Model$BrowseType = function (a) {
	return {ctor: 'BrowseType', _0: a};
};
var _user$project$Message_Edit_Model$BrowseCount = function (a) {
	return {ctor: 'BrowseCount', _0: a};
};
var _user$project$Message_Edit_Model$BrowseFrom = function (a) {
	return {ctor: 'BrowseFrom', _0: a};
};
var _user$project$Message_Edit_Model$Url = function (a) {
	return {ctor: 'Url', _0: a};
};
var _user$project$Message_Edit_Model$RawMessage = function (a) {
	return {ctor: 'RawMessage', _0: a};
};
var _user$project$Message_Edit_Model$ToggleExpandedId = {ctor: 'ToggleExpandedId'};
var _user$project$Message_Edit_Model$CustomId = function (a) {
	return {ctor: 'CustomId', _0: a};
};
var _user$project$Message_Edit_Model$NextId = {ctor: 'NextId'};
var _user$project$Message_Edit_Model$Id = function (a) {
	return {ctor: 'Id', _0: a};
};
var _user$project$Message_Edit_Model$SelectEditTab = function (a) {
	return {ctor: 'SelectEditTab', _0: a};
};

var _user$project$Model$initialModel = {
	connection: _user$project$Connection$model('main'),
	mdl: _debois$elm_mdl$Material$model,
	edit: _user$project$Message_Edit_Model$model
};
var _user$project$Model$Model = F3(
	function (a, b, c) {
		return {connection: a, mdl: b, edit: c};
	});
var _user$project$Model$NoOp = {ctor: 'NoOp'};
var _user$project$Model$Edit = function (a) {
	return {ctor: 'Edit', _0: a};
};
var _user$project$Model$SendRequest = function (a) {
	return {ctor: 'SendRequest', _0: a};
};
var _user$project$Model$Mdl = function (a) {
	return {ctor: 'Mdl', _0: a};
};
var _user$project$Model$initialCmd = _debois$elm_mdl$Material$init(_user$project$Model$Mdl);
var _user$project$Model$init = {ctor: '_Tuple2', _0: _user$project$Model$initialModel, _1: _user$project$Model$initialCmd};
var _user$project$Model$Conn = function (a) {
	return {ctor: 'Conn', _0: a};
};

var _user$project$Message_Edit_Parts$decapitalize = function (s) {
...
var _user$project$Message_Edit_Parts$textfield = F6(
	function (ctx, index, label, value, msg, options) {
		return A5(
			...
			A2(
				_elm_lang$core$Basics_ops['++'],
				{
					ctor: '::',
					_0: _debois$elm_mdl$Material_Options$cs(
						_user$project$Message_Edit_Parts$decapitalize(label)),
					_1: {
						ctor: '::',
...
var _user$project$Message_Edit_Parts$url = F3(
	function (ctx, index, model) {
		return A6(
			_user$project$Message_Edit_Parts$textfield,
			ctx,
			index,
			'Url',
			model.url,
			_user$project$Message_Edit_Model$Url,
			{
				ctor: '::',
...
var _user$project$Message_Edit_Raw$validJsonString = function (str) {
	return A2(
...
var _user$project$Message_Edit_Raw$rawResult = function (_p0) {
	return A2(
		_elm_lang$core$Json_Decode$decodeString,
		_elm_lang$core$Json_Decode$value,
		function (_) {
...
var _user$project$Message_Edit_Raw$rawEdit = F3(
	function (ctx, send, model) {
		return A2(
			_elm_lang$html$Html$div,
			{
				ctor: '::',
				_0: _elm_lang$html$Html_Attributes$class('rawEdit'),
				_1: {ctor: '[]'}
			},
			{
				ctor: '::',
				_0: A6(
					...
					'Message',
					model.rawMessage,
					_user$project$Message_Edit_Model$RawMessage,
					{
						ctor: '::',
						_0: _debois$elm_mdl$Material_Textfield$autofocus,
						_1: {
							...
							_0: A2(
								_debois$elm_mdl$Material_Options$when,
								!_user$project$Message_Edit_Raw$validJsonString(model.rawMessage),
								_debois$elm_mdl$Material_Textfield$error('Invalid JSON')),
							_1: {ctor: '[]'}
						}
					}),
				_1: {
					ctor: '::',
					_0: A2(send, ctx, model),
					_1: {ctor: '[]'}
				}
			});
	});

var _user$project$Message_Edit_ObserveItem$observeItemResult = function (model) {
	return _elm_lang$core$Result$Ok(
		_elm_lang$core$Json_Encode$object(
			{
				...
				_1: {
					...
					_0: {
						ctor: '_Tuple2',
						_0: 'method',
						_1: _elm_lang$core$Json_Encode$string('observeItem')
					},
					_1: {ctor: '[]'}
				}
			}));
};
var _user$project$Message_Edit_ObserveItem$observeItemEdit = F3(
	function (ctx, send, model) {
		return A2(
			_elm_lang$html$Html$div,
			{
				ctor: '::',
				_0: _elm_lang$html$Html_Attributes$class('observeEdit'),
				_1: {ctor: '[]'}
			},
			{
				ctor: '::',
				_0: A3(
					_user$project$Message_Edit_Parts$url,
					ctx,
					{
						ctor: '::',
						_0: 2,
...
var _user$project$Message_Edit_Browse$browseTypeValue = function (t) {
	var _p0 = t;
	switch (_p0.ctor) {
		case 'Normal':
			return _elm_lang$core$Maybe$Nothing;
		case 'Incremental':
			return _elm_lang$core$Maybe$Just('incremental');
		default:
			return _elm_lang$core$Maybe$Just('menu');
	}
};
var _user$project$Message_Edit_Browse$browseTypeCaption = function (t) {
	var _p1 = t;
	switch (_p1.ctor) {
		case 'Normal':
			return 'Normal';
...
var _user$project$Message_Edit_Browse$showBrowseTypes = {
	ctor: '::',
	_0: _user$project$Message_Edit_Model$Normal,
	_1: {
		ctor: '::',
		_0: _user$project$Message_Edit_Model$Incremental,
		_1: {
			ctor: '::',
			_0: _user$project$Message_Edit_Model$Menu,
			_1: {ctor: '[]'}
		}
	}
};
var _user$project$Message_Edit_Browse$browseResult = function (model) {
	var maybeJsonInt = function (_p2) {
		return A2(
			_elm_lang$core$Maybe$map,
						...
						A2(
							...
							},
							{
								...
								_0: {
									ctor: '_Tuple2',
									_0: 'from',
									_1: maybeJsonInt(model.browseFrom)
								},
								_1: {
									ctor: '::',
									_0: {
										ctor: '_Tuple2',
										_0: 'count',
										_1: maybeJsonInt(model.browseCount)
									},
									_1: {
										ctor: '::',
										_0: {
											...
											_1: A2(
												...
												_user$project$Message_Edit_Browse$browseTypeValue(model.browseType))
										},
										_1: {ctor: '[]'}
									}
								}
				...
				_1: {
					...
					_1: {
						...
						_0: {
							ctor: '_Tuple2',
							_0: 'method',
							_1: _elm_lang$core$Json_Encode$string('browse')
						},
						_1: {ctor: '[]'}
					}
				}
...
var _user$project$Message_Edit_Browse$browseEdit = F3(
	function (ctx, send, model) {
		var isValidInt = function (str) {
			return _elm_community$result_extra$Result_Extra$isOk(
				_elm_lang$core$String$toInt(str)) || _elm_lang$core$String$isEmpty(str);
		};
		var validateInt = function (str) {
			return A2(
				_debois$elm_mdl$Material_Options$when,
				!isValidInt(str),
				_debois$elm_mdl$Material_Textfield$error('Number!'));
		};
		return A2(
			_elm_lang$html$Html$div,
			{
				ctor: '::',
				_0: _elm_lang$html$Html_Attributes$class('browseEdit'),
				_1: {ctor: '[]'}
			},
			{
				ctor: '::',
				...
				_1: {
					...
					_0: A6(
						...
						'from',
						model.browseFrom,
						_user$project$Message_Edit_Model$BrowseFrom,
						{
							ctor: '::',
							_0: validateInt(model.browseFrom),
							_1: {ctor: '[]'}
						}),
					_1: {
						ctor: '::',
						_0: A6(
							...
							'count',
							model.browseCount,
							_user$project$Message_Edit_Model$BrowseCount,
							{
								ctor: '::',
								_0: validateInt(model.browseCount),
								_1: {ctor: '[]'}
							}),
						_1: {
							ctor: '::',
							_0: A5(
								...
								{
									ctor: '::',
									_0: _debois$elm_mdl$Material_Options$cs('type'),
									_1: {
										ctor: '::',
										_0: _debois$elm_mdl$Material_Select$label('type'),
										_1: {
											ctor: '::',
											_0: _debois$elm_mdl$Material_Select$floatingLabel,
											_1: {
												ctor: '::',
												_0: _debois$elm_mdl$Material_Select$over,
												_1: {
													ctor: '::',
													_0: _debois$elm_mdl$Material_Select$value(
														_user$project$Message_Edit_Browse$browseTypeCaption(model.browseType)),
													_1: {ctor: '[]'}
												}
											}
										}
										...
										return A2(
											_debois$elm_mdl$Material_Select$item,
											{
												...
												_0: _debois$elm_mdl$Material_Dropdown_Item$onSelect(
													ctx.msgLift(
														_user$project$Message_Edit_Model$BrowseType(bt))),
												_1: {ctor: '[]'}
											},
											{
												ctor: '::',
												_0: _elm_lang$html$Html$text(
													_user$project$Message_Edit_Browse$browseTypeCaption(bt)),
												_1: {ctor: '[]'}
											});
									},
									_user$project$Message_Edit_Browse$showBrowseTypes)),
							_1: {
								ctor: '::',
								_0: A2(send, ctx, model),
								_1: {ctor: '[]'}
...
var _user$project$Message_Edit$id = function (model) {
	var _p0 = model.id;
	switch (_p0.ctor) {
		case 'AutoInc':
			return _elm_lang$core$Maybe$Just(
				_elm_lang$core$Basics$toString(model.nextAutoId));
		case 'None':
			return _elm_lang$core$Maybe$Nothing;
		default:
			return _elm_lang$core$Maybe$Just(model.customId);
	}
};
var _user$project$Message_Edit$idValue = function (model) {
	return A2(
		_elm_lang$core$Maybe$map,
		F2(
			function (v0, v1) {
		...
		A2(
			_elm_lang$core$Maybe$map,
			_elm_lang$core$Json_Encode$string,
			_user$project$Message_Edit$id(model)));
};
var _user$project$Message_Edit$idSelect = F2(
	function (ctx, model) {
		return A2(
			_elm_lang$html$Html$div,
			{
				ctor: '::',
				_0: _elm_lang$html$Html_Attributes$class('idSelect'),
				_1: {ctor: '[]'}
			},
			{
				ctor: '::',
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html_Attributes$class('autonone'),
						_1: {ctor: '[]'}
					},
					{
						ctor: '::',
						_0: A5(
							...
							{
								ctor: '::',
								_0: _debois$elm_mdl$Material_Toggles$group('idSelect'),
								_1: {
									ctor: '::',
									...
									_1: {
										...
										_0: _debois$elm_mdl$Material_Toggles$value(
											_elm_lang$core$Native_Utils.eq(model.id, _user$project$Message_Edit_Model$AutoInc)),
										_1: {
											ctor: '::',
											_0: _debois$elm_mdl$Material_Options$onToggle(
												ctx.msgLift(
													_user$project$Message_Edit_Model$Id(_user$project$Message_Edit_Model$AutoInc))),
											_1: {ctor: '[]'}
										}
									}
								}
								...
								ctx.mdl,
								{
									...
									_1: {
										...
										_1: {
											ctor: '::',
											_0: _debois$elm_mdl$Material_Toggles$value(
												_elm_lang$core$Native_Utils.eq(model.id, _user$project$Message_Edit_Model$None)),
											_1: {
												ctor: '::',
												_0: _debois$elm_mdl$Material_Options$onToggle(
													ctx.msgLift(
														_user$project$Message_Edit_Model$Id(_user$project$Message_Edit_Model$None))),
												_1: {ctor: '[]'}
											}
										}
									}
						...
						ctx.mdl,
						{
							...
							_1: {
								...
								_1: {
									ctor: '::',
									_0: _debois$elm_mdl$Material_Toggles$value(
										_elm_lang$core$Native_Utils.eq(model.id, _user$project$Message_Edit_Model$Custom)),
									_1: {
										ctor: '::',
										_0: _debois$elm_mdl$Material_Options$onToggle(
											ctx.msgLift(
												_user$project$Message_Edit_Model$Id(_user$project$Message_Edit_Model$Custom))),
										_1: {ctor: '[]'}
									}
								}
							}
							...
							_0: A2(
								_elm_lang$html$Html$input,
								{
									...
									_1: {
										...
										_1: {
											ctor: '::',
											_0: _elm_lang$html$Html_Attributes$placeholder('Custom'),
											_1: {
												ctor: '::',
												_0: _elm_lang$html$Html_Attributes$value(model.customId),
												_1: {
													ctor: '::',
													_0: _elm_lang$html$Html_Events$onInput(
														function (_p1) {
															return ctx.msgLift(
																_user$project$Message_Edit_Model$CustomId(_p1));
														}),
													_1: {ctor: '[]'}
												}
											}
...
var _user$project$Message_Edit$tabEditResult = function (tab) {
	var _p2 = tab;
	switch (_p2.ctor) {
		case 'ObserveItem':
			return _user$project$Message_Edit_ObserveItem$observeItemResult;
		case 'Browse':
			return _user$project$Message_Edit_Browse$browseResult;
		default:
			return _user$project$Message_Edit_Raw$rawResult;
	}
};
var _user$project$Message_Edit$tabContent = function (tab) {
	var _p3 = tab;
	switch (_p3.ctor) {
		case 'ObserveItem':
			return _user$project$Message_Edit_ObserveItem$observeItemEdit;
		case 'Browse':
			return _user$project$Message_Edit_Browse$browseEdit;
		default:
			return _user$project$Message_Edit_Raw$rawEdit;
	}
};
var _user$project$Message_Edit$tabLabelText = function (tab) {
	var _p4 = tab;
	switch (_p4.ctor) {
		case 'ObserveItem':
			return {
				...
				_1: {
					ctor: '::',
					_0: _elm_lang$html$Html$text('observeItem'),
					_1: {ctor: '[]'}
				}
			};
		case 'Browse':
			return {
				ctor: '::',
				_0: _debois$elm_mdl$Material_Icon$i('folder'),
				_1: {
					ctor: '::',
...
var _user$project$Message_Edit$update = F2(
	function (msg, model) {
		var m = function () {
			var _p5 = msg;
			switch (_p5.ctor) {
				...
				case 'NextId':
					return _elm_lang$core$Native_Utils.update(
						model,
						{nextAutoId: model.nextAutoId + 1});
				case 'CustomId':
					return _elm_lang$core$Native_Utils.update(
						model,
						{customId: _p5._0});
				case 'ToggleExpandedId':
					return _elm_lang$core$Native_Utils.update(
						model,
...
var _user$project$Message_Edit$Raw = {ctor: 'Raw'};
var _user$project$Message_Edit$Browse = {ctor: 'Browse'};
var _user$project$Message_Edit$ObserveItem = {ctor: 'ObserveItem'};
var _user$project$Message_Edit$showTabs = {
	ctor: '::',
	_0: _user$project$Message_Edit$ObserveItem,
	_1: {
		ctor: '::',
		_0: _user$project$Message_Edit$Browse,
		_1: {
			ctor: '::',
			_0: _user$project$Message_Edit$Raw,
			_1: {ctor: '[]'}
		}
	}
};
var _user$project$Message_Edit$tabAtIndex = function (i) {
	return A2(
		_elm_lang$core$Maybe$withDefault,
		_user$project$Message_Edit$Raw,
		_elm_lang$core$List$head(
			A2(_elm_lang$core$List$drop, i, _user$project$Message_Edit$showTabs)));
};
var _user$project$Message_Edit$activeTab = function (_p6) {
	return _user$project$Message_Edit$tabAtIndex(
		function (_) {
			return _.activeTab;
		}(_p6));
};
var _user$project$Message_Edit$messageToSend = function (model) {
	var keyValues = A2(
		_elm_lang$core$Result$andThen,
		_elm_lang$core$Json_Decode$decodeValue(
			_elm_lang$core$Json_Decode$keyValuePairs(_elm_lang$core$Json_Decode$value)),
		A2(
			_user$project$Message_Edit$tabEditResult,
			_user$project$Message_Edit$tabAtIndex(model.activeTab),
			model));
	var _p7 = {
		ctor: '_Tuple2',
		_0: _user$project$Message_Edit$activeTab(model),
		_1: keyValues
	};
	if (((_p7.ctor === '_Tuple2') && (_p7._0.ctor === 'Raw')) && (_p7._1.ctor === 'Err')) {
			...
			_elm_lang$core$Json_Encode$object(
				A2(
					...
					A2(
						...
						{
							ctor: '::',
							_0: _user$project$Message_Edit$idValue(model),
							_1: {ctor: '[]'}
						}),
					A2(
						_elm_lang$core$Result$withDefault,
...
var _user$project$Message_Edit$sendButton = F2(
	function (ctx, model) {
		return A2(
			_elm_lang$html$Html$div,
			{
				...
				_0: A2(
					_elm_lang$html$Html$div,
					{
						...
						_0: _elm_lang$html$Html_Attributes$classList(
							{
								ctor: '::',
								_0: {ctor: '_Tuple2', _0: 'idpreview', _1: true},
								_1: {
									ctor: '::',
									_0: {ctor: '_Tuple2', _0: 'expanded', _1: model.expandedId},
									_1: {ctor: '[]'}
								}
							}),
						_1: {
							ctor: '::',
							_0: _elm_lang$html$Html_Events$onClick(
								ctx.msgLift(_user$project$Message_Edit_Model$ToggleExpandedId)),
							_1: {ctor: '[]'}
						}
					},
					{
						...
						ctx.mdl,
						{
							...
							_1: {
								...
								_1: {
									...
									_0: _debois$elm_mdl$Material_Options$onClick(
										ctx.sendRequest(
											_user$project$Message_Edit$messageToSend(model))),
									_1: {ctor: '[]'}
								}
							}
						},
...
var _user$project$Message_Edit$sendWithId = F2(
	function (ctx, model) {
		return A2(
			_elm_lang$html$Html$div,
			{
				ctor: '::',
				_0: _elm_lang$html$Html_Attributes$class('sendWithId'),
				_1: {ctor: '[]'}
			},
			A2(
				_elm_lang$core$List$filterMap,
				...
				{
					ctor: '::',
					_0: model.expandedId ? _elm_lang$core$Maybe$Just(
						A2(_user$project$Message_Edit$idSelect, ctx, model)) : _elm_lang$core$Maybe$Nothing,
					_1: {
						ctor: '::',
						_0: _elm_lang$core$Maybe$Just(
							A2(_user$project$Message_Edit$sendButton, ctx, model)),
						_1: {ctor: '[]'}
					}
				}));
	});
var _user$project$Message_Edit$view = F2(
	function (ctx, model) {
		var tabLabel = function (t) {
			return A2(
				_debois$elm_mdl$Material_Tabs$label,
				{
					ctor: '::',
				...
				_user$project$Message_Edit$tabLabelText(t));
		};
		return A6(
			...
			{
				ctor: '::',
				_0: _debois$elm_mdl$Material_Tabs$activeTab(model.activeTab),
				_1: {
					ctor: '::',
					_0: _debois$elm_mdl$Material_Tabs$onSelectTab(
						function (_p8) {
							return ctx.msgLift(
								_user$project$Message_Edit_Model$SelectEditTab(_p8));
						}),
					_1: {
						ctor: '::',
						_0: _debois$elm_mdl$Material_Options$cs('messageEdit'),
						_1: {ctor: '[]'}
					}
				}
			},
			A2(_elm_lang$core$List$map, tabLabel, _user$project$Message_Edit$showTabs),
			{
				ctor: '::',
				_0: A4(
					_user$project$Message_Edit$tabContent,
					_user$project$Message_Edit$tabAtIndex(model.activeTab),
					ctx,
					_user$project$Message_Edit$sendWithId,
					model),
				_1: {ctor: '[]'}
			});
	});

var _user$project$Update$edit = A2(
	_user$project$Delegate$create,
	function (_) {
		return _.edit;
	},
	F2(
...
var _user$project$Update$update = F2(
	function (msg, model) {
		...
		switch (_p0.ctor) {
			...
			case 'Conn':
				var _p1 = A3(_user$project$Connection$update, _user$project$Model$Conn, _p0._0, model.connection);
				var cm = _p1._0;
				var ccmd = _p1._1;
				return {
					ctor: '_Tuple2',
			...
			case 'SendRequest':
				var _p2 = A2(_user$project$Message_Edit$update, _user$project$Message_Edit_Model$NextId, model.edit);
				var em = _p2._0;
				var ec = _p2._1;
				var _p3 = A3(_user$project$Connection$send, _user$project$Model$Conn, model.connection, _p0._0);
				var cm = _p3._0;
				var cc = _p3._1;
				return {
					ctor: '_Tuple2',
			...
			case 'Edit':
				return A3(
					_user$project$Delegate$delegate,
					_user$project$Update$edit,
					model,
					_user$project$Message_Edit$update(_p0._0));
			default:
				return {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none};
		}
	});
var _user$project$Update$connection = A2(
	_user$project$Delegate$create,
	function (_) {
		return _.connection;
	},
...
var _user$project$View$formatTs = function (_p0) {
	return A3(
		_rluiten$elm_date_extra$Date_Extra_Format$format,
		_rluiten$elm_date_extra$Date_Extra_Config_Configs$getConfig('en_US'),
		'%H:%M:%S',
		_elm_lang$core$Date$fromTime(_p0));
};
var _user$project$View$message = function (msg) {
	var o = function () {
		var _p1 = msg;
		switch (_p1.ctor) {
			case 'Sent':
				return {
					...
					text: A2(
						_elm_lang$core$Basics_ops['++'],
						_user$project$View$formatTs(_p1._0),
						A2(_elm_lang$core$Basics_ops['++'], ': ', _p1._1))
				};
			case 'Received':
				var _p2 = _p1._1;
				return {
					cls: A2(_elm_lang$core$String$contains, '\"error\":', _p2) ? 'error' : 'incomming',
					text: A2(
						_elm_lang$core$Basics_ops['++'],
						_user$project$View$formatTs(_p1._0),
			...
			case 'Opened':
				return {
					...
					text: A2(
						_elm_lang$core$Basics_ops['++'],
						_user$project$View$formatTs(_p1._0),
						A2(_elm_lang$core$Basics_ops['++'], ': Opened ', _p1._1))
				};
			default:
				return {
					cls: 'error',
					text: A2(
						_elm_lang$core$Basics_ops['++'],
						_user$project$View$formatTs(_p1._0),
						A2(_elm_lang$core$Basics_ops['++'], ': Closed ', _p1._1))
				};
		}
	}();
	return A2(
		...
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Attributes$class(o.cls),
			_1: {ctor: '[]'}
		},
		{
			ctor: '::',
			_0: _elm_lang$html$Html$text(o.text),
			_1: {ctor: '[]'}
		});
};
var _user$project$View$messages = function (msgs) {
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
		...
		A2(_elm_lang$core$List$map, _user$project$View$message, msgs));
};
var _user$project$View$editContext = function (model) {
	return A4(_user$project$Message_Edit_Model$context, _user$project$Model$Edit, _user$project$Model$SendRequest, _user$project$Model$Mdl, model.mdl);
};
var _user$project$View$consoleView = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Attributes$class('console'),
			_1: {ctor: '[]'}
		},
		{
			ctor: '::',
			_0: _user$project$View$messages(model.connection.messages),
			_1: {
				ctor: '::',
				_0: A2(
					_user$project$Message_Edit$view,
					_user$project$View$editContext(model),
					model.edit),
				_1: {ctor: '[]'}
			}
		});
		...
		_0: A2(
			...
			{ctor: '[]'},
			{
				...
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html$text('DevConsole'),
						_1: {ctor: '[]'}
					}),
				_1: {
					ctor: '::',
					...
					_1: {
						ctor: '::',
						_0: _elm_lang$html$Html$text(model.connection.url),
						_1: {ctor: '[]'}
					}
				}
			}),
...
var _user$project$View$view = function (model) {
	return A4(
		...
		{ctor: '[]'},
		{
			...
			main: {
				ctor: '::',
				_0: _user$project$View$consoleView(model),
				_1: {ctor: '[]'}
			}
		});
};

var _user$project$DevConsole$subscriptions = function (model) {
	return _elm_lang$core$Platform_Sub$batch(
		{
			ctor: '::',
			_0: A2(_user$project$Connection$subscriptions, _user$project$Model$Conn, model.connection),
			_1: {
				ctor: '::',
				_0: A2(_debois$elm_mdl$Material$subscriptions, _user$project$Model$Mdl, model),
				_1: {
					ctor: '::',
					_0: A2(_debois$elm_mdl$Material_Select$subs, _user$project$Model$Mdl, model.mdl),
					_1: {ctor: '[]'}
				}
			}
		});
};
var _user$project$DevConsole$main = _elm_lang$html$Html$program(
	{init: _user$project$Model$init, update: _user$project$Update$update, view: _user$project$View$view, subscriptions: _user$project$DevConsole$subscriptions})();

var Elm = {};
Elm['DevConsole'] = Elm['DevConsole'] || {};
if (typeof _user$project$DevConsole$main !== 'undefined') {
    _user$project$DevConsole$main(Elm['DevConsole'], 'DevConsole', undefined);
}
